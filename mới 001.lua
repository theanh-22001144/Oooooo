loadstring(game:HttpGet(("https://raw.githubusercontent.com/daucobonhi/Ui-Redz-V2/refs/heads/main/UiREDzV2.lua")))()
       ...
       local Window = MakeWindow({
         Hub = {
         Title = "thế anh (  script tổng hợp)",
         Animation = "quá là đẹp trai"
         },
        Key = {
        KeySystem = false,
        Title = "Key System",
       ...
       MinimizeButton({
       Image = "http://www.roblox.com/asset/?id= 130704611042044",
       Size = {50, 50},
...
------ Tab
     ...
     local Tab3o = MakeTab({Name = "Script xịn"})
     local Tab4o = MakeTab({Name = "Script fix lag"})
     local Tab5o = MakeTab({Name = "Script hop"})
     local Tab6o = MakeTab({Name = "Script tao làm"})
...
AddButton(Tab6o, {
     Name = "script fam",
    Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/theanh-22001144/Sgshsbs/refs/heads/main/TBoy.lua"))()
end 
})
AddButton(Tab2o, {
     Name = "script longhip",
